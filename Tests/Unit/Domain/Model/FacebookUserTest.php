...
/**
 * Test case for class Tx_WsLogin_Domain_Model_FacebookUser.
 *
 * @version $Id$
 ...
 */
class Tx_WsLogin_Domain_Model_FacebookUserTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	...
	public function setUp() {
		$this->fixture = new Tx_WsLogin_Domain_Model_FacebookUser();
	}
	 ...
	 * @test
	 */
	public function getWsFacebookIdReturnsInitialValueForString() {
        $this->assertSame(
            null,
            $this->fixture->getWsFacebookId()
        );
    }
	 ...
	 * @test
	 */
	public function setWsFacebookIdForStringSetsWsFacebookId() { 
		$this->fixture->setWsFacebookId('Conceived at T3CON10');
