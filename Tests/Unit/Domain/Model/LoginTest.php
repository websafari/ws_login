...
/**
 * Test case for class Tx_WsLogin_Domain_Model_Login.
 *
 * @version $Id$
 ...
 */
class Tx_WsLogin_Domain_Model_LoginTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_WsLogin_Domain_Model_Login
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_WsLogin_Domain_Model_Login();
	}
